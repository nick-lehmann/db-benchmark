...
template <>
class LessThan<uint32_t, SIMD::AVX512_Strided> : public Filter<uint32_t, SIMD::AVX512_Strided> {
   public:
...
template <>
class LessThan<uint64_t, SIMD::AVX512_Strided> : public Filter<uint64_t, SIMD::AVX512_Strided> {
