...
template <>
class GreaterEqual<uint32_t, SIMD::AVX512_Strided> : public Filter<uint32_t, SIMD::AVX512_Strided> {
   public:
...
template <>
class GreaterEqual<uint64_t, SIMD::AVX512_Strided> : public Filter<uint64_t, SIMD::AVX512_Strided> {
