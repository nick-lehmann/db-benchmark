...
template <>
class GreaterThan<uint32_t, SIMD::AVX512_Strided> : public Filter<uint32_t, SIMD::AVX512_Strided> {
   public:
...
template <>
class GreaterThan<uint64_t, SIMD::AVX512_Strided> : public Filter<uint64_t, SIMD::AVX512_Strided> {
