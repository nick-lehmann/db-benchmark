...
int main(int argc, char** argv) {
    ...
    Benchmark::benchmarkRows<Type, SIMD::AVX512>(1, projection, filters_AVX, 100, 50, false, 100, 500, 0, 100, 0,
                                                 "../output_files/CSbenchmark_AVX.csv");
    Benchmark::benchmarkRows<Type, SIMD::AVX512>(0, projection, filters_AVX, 100, 50, false, 100, 500, 0, 100, 0,
                                                 "../output_files/RSbenchmark_AVX.csv");
    ...
    Benchmark::benchmarkRows<Type, SIMD::None>(1, projection, filters, 100, 50, false, 100, 500, 0, 100, 0,
                                               "../output_files/CSbenchmark_Scalar.csv");
    Benchmark::benchmarkRows<Type, SIMD::None>(0, projection, filters, 100, 50, false, 100, 500, 0, 100, 0,
                                               "../output_files/RSbenchmark_Scalar.csv");
